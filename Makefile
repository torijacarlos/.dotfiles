...
DOTFILES_APPS=hypr wofi waybar kitty zsh nvim tmux bin git

SYSTEM_PACKAGES=bluez bluez-utils brightnessctl \
...
UTIL_PACKAGES=fzf ripgrep tig tmux stow man-db man-pages waybar xclip rclone hyprpaper swaybg
DEV_PACKAGES=heaptrack jq cmake gdb clang-tools-extra raylib
APP_PACKAGES=krita audacity obs-studio discord chromium steam blender
FONT_PACKAGES=ttf-hack-nerd otf-font-awesome ttf-nerd-fonts-symbols ttf-droid
